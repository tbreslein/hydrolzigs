...
pub fn NumFlux(comptime c: Config) type {
    ...
    // const dist_west: [c.mesh.n]f64 = @Vector(c.mesh.n, f64){mesh.xi_west} - @Vector(c.mesh.n, f64){mesh.xi_cent};
    // const dist_east: [c.mesh.n]f64 = @Vector(c.mesh.n, f64){mesh.xi_east} - @Vector(c.mesh.n, f64){mesh.xi_cent};
